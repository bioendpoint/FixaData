    ...
    function appendCellHtml(stringArray, row, cell, colspan, item) {
      ...
      
      {
    	  if($("#strdHeaderList").length>0){
    		  ...
    		  if(Options.Variable.slickGrid.headerOption["prepGrid"][cell].data_type=="date")
              {
        		  cellCss = cellCss.replace("right-align","left-align");
              }
        	  else if(Options.Variable.slickGrid.headerOption["prepGrid"][cell].data_type=="number")
              {
        		  cellCss = cellCss.replace("left-align","right-align");
              }
        	  else if(Options.Variable.slickGrid.headerOption["prepGrid"][cell].data_type=="char")
              {
        		  cellCss = cellCss.replace("right-align","left-align");
              }
        	  else if(Options.Variable.slickGrid.headerOption["prepGrid"][cell].data_type=="label")
              {
        		  cellCss = cellCss.replace("right-align","left-align");
              }
